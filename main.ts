...
export default class OpenWebUIKBSyncPlugin extends Plugin {
    ...
    async onload() {
        ...
        // Add ribbon icon
        const ribbonIconEl = this.addRibbonIcon('cloud-upload', 'Sync to OpenWebUI Knowledge Base', async (evt: MouseEvent) => {
...
class OpenWebUIKBSyncSettingTab extends PluginSettingTab {
    ...
    displaySyncStatus(containerEl: HTMLElement): void {
        ...
        const statusSpan = statusPara.createEl('span', { text: statusText, cls: 'kb-sync-status' });
